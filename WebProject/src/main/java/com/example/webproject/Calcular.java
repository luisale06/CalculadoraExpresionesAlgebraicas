...
/**
 * Servlet que implementa el calculo de la expresion algebraica introducida y almacena en el registro csv
 * la fecha, la expresion y el resultado
...
public class Calcular extends HttpServlet {
    ...
    /**
     * metodo predefinido de los servlets. Adquiere la expresion introducida por el usuario en el archivo
     * index.jsp (pagina principal de la interfaz web) y la resuelve. Seguidamente, la despliega en pantalla
     * junto con la fecha de resolucion. Finalmente, almacena en el archivo csv el nombre de usuario introducido,
     * la fecha de resolucion, la expresion algebraica y el resultado obtenido
     * @param request
     * @param response
     * @throws IOException
     */
