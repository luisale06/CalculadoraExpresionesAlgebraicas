...
public class historialExpresiones extends HttpServlet {
    ...
    /**
     * Método predefinido de los servlets, encargado de recibir el nombre de usuario de referencia
     * para buscar en el archivo csv el historial de cálculos a nombre del mismo.
     * @param request
     * @param response
     * @throws IOException
     */
